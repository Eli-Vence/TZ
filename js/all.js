  ...
  $.fn.timeTo = function() {
      ...
      return this.each(function() {
          ...
          if (!data.vals) {
              ...
              data.width = Math.round(data.fontSize * .8 + data.height * .13) || data.width;
              ...
              captionSize = data.captionSize || data.fontSize && Math.round(data.fontSize * .43);
              ...
              if (data.displayDays > 0) {
                  marginRight = Math.round(data.fontSize * .4 || defaults.gap);
                  dhtml = dhtml1;
                  ...
                  thtml = (data.displayCaptions ? '<figure style="width:' + (data.width * data.displayDays + marginRight + 4) + 'px">$1' + '<figcaption style="' + fsStyleVal + "padding-right:" + marginRight + 'px">' + language.days + "</figcaption></figure>" : "$1").replace(/\$1/, dhtml) + thtml
              }
              $this.html(thtml)
...
$(window).on("load", function() {
  ...
  $("a").not('.policy').attr("href", "#boxesContainer");
